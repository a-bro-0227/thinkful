...
Using a different time series dataset (either from [FRED](https://fred.stlouisfed.org) or elsewhere), go about the process of time series modeling. Specifically, generate the following deliverables:
